 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var rm;function $0(){if(rm)return ra;rm=1;var s=mf(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),i=Object.prototype.hasOwnProperty,o=s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,a={key:!0,ref:!0,__self:!0,__source:!0};function c(u,f,h){var p,m={},_=null,S=null;h!==void 0&&(_=""+h),f.key!==void 0&&(_=""+f.key),f.ref!==void 0&&(S=f.ref);for(p in f)i.call(f,p)&&!a.hasOwnProperty(p)&&(m[p]=f[p]);if(u&&u.defaultProps)for(p in f=u.defaultProps,f)m[p]===void 0&&(m[p]=f[p]);return{$$typeof:e,type:u,key:_,ref:S,props:m,_owner:o.current}}return ra.Fragment=t,ra.jsx=c,ra.jsxs=c,ra}var sm;function Z0(){return sm||(sm=1,sd.exports=$0()),sd.exports}var A=Z0(),ye=mf();const h_=f_(ye),Q0=Y0({__proto__:null,default:h_},[ye]);var Pl={},ad={exports:{}},kn={},ld={exports:{}},cd={};/**
 * @license React
...
#endif`,RE="gl_FragColor = linearToOutputTexel( gl_FragColor );",bE=`
...
#define LOW_PRECISION`),e}function Qw(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===R_?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===dy?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===qi&&(e="SHADOWMAP_TYPE_VSM"),e}function Jw(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case uo:case fo:e="ENVMAP_TYPE_CUBE";break;case yc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function eA(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case fo:e="ENVMAP_MODE_REFRACTION";break}return e}function tA(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case b_:e="ENVMAP_BLENDING_MULTIPLY";break;case Uy:e="ENVMAP_BLENDING_MIX";break;case Fy:e="ENVMAP_BLENDING_ADD";break}return e}function nA(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function iA(s,e,t,i){const o=s.getContext(),a=t.defines;let c=t.vertexShader,u=t.fragmentShader;const f=Qw(t),h=Jw(t),p=eA(t),m=tA(t),_=nA(t),S=t.isWebGL2?"":Gw(t),E=Ww(t),M=jw(a),v=o.createProgram();let y,C,w=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(oo).join(`
`)),c=uf(c),c=Ug(c,t),c=Fg(c,t),u=uf(u),u=Ug(u,t),u=Fg(u,t),c=Og(c),u=Og(u),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([c]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){const o=new Worker(this.workerSourceURL);o._callbacks={},o._taskCosts={},o._taskLoad=0,o.postMessage({type:"init",decoderConfig:this.decoderConfig}),o.onmessage=function(a){const c=a.data;switch(c.type){case"decode":o._callbacks[c.id].resolve(c);break;case"error":o._callbacks[c.id].reject(c);break;default:console.error('THREE.DRACOLoader: Unexpected message, "'+c.type+'"')}},this.workerPool.push(o)}else this.workerPool.sort(function(o,a){return o._taskLoad>a._taskLoad?-1:1});const i=this.workerPool[this.workerPool.length-1];return i._taskCosts[e]=t,i._taskLoad+=t,i})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log("Task load: ",this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==""&&URL.revokeObjectURL(this.workerSourceURL),this}}function Q1(){let s,e;onmessage=function(c){const u=c.data;switch(u.type){case"init":s=u.decoderConfig,e=new Promise(function(p){s.onModuleLoaded=function(m){p({draco:m})},DracoDecoderModule(s)});break;case"decode":const f=u.buffer,h=u.taskConfig;e.then(p=>{const m=p.draco,_=new m.Decoder;try{const S=t(m,_,new Int8Array(f),h),E=S.attributes.map(M=>M.array.buffer);S.index&&E.push(S.index.array.buffer),self.postMessage({type:"decode",id:u.id,geometry:S},E)}catch(S){console.error(S),self.postMessage({type:"error",id:u.id,error:S.message})}finally{m.destroy(_)}});break}};function t(c,u,f,h){const p=h.attributeIDs,m=h.attributeTypes;let _,S;const E=u.GetEncodedGeometryType(f);if(E===c.TRIANGULAR_MESH)_=new c.Mesh,S=u.DecodeArrayToMesh(f,f.byteLength,_);else if(E===c.POINT_CLOUD)_=new c.PointCloud,S=u.DecodeArrayToPointCloud(f,f.byteLength,_);else throw new Error("THREE.DRACOLoader: Unexpected geometry type.");if(!S.ok()||_.ptr===0)throw new Error("THREE.DRACOLoader: Decoding failed: "+S.error_msg());const M={index:null,attributes:[]};for(const v in p){const y=self[m[v]];let C,w;if(h.useUniqueIDs)w=p[v],C=u.GetAttributeByUniqueId(_,w);else{if(w=u.GetAttributeId(_,c[p[v]]),w===-1)continue;C=u.GetAttribute(_,w)}const L=o(c,u,_,v,y,C);v==="color"&&(L.vertexColorSpace=h.vertexColorSpace),M.attributes.push(L)}return E===c.TRIANGULAR_MESH&&(M.index=i(c,u,_)),c.destroy(_),M}function i(c,u,f){const p=f.num_faces()*3,m=p*4,_=c._malloc(m);u.GetTrianglesUInt32Array(f,m,_);const S=new Uint32Array(c.HEAPF32.buffer,_,p).slice();return c._free(_),{array:S,itemSize:1}}function o(c,u,f,h,p,m){const _=m.num_components(),E=f.num_points()*_,M=E*p.BYTES_PER_ELEMENT,v=a(c,p),y=c._malloc(M);u.GetAttributeDataArrayForAllPoints(f,m,v,M,y);const C=new p(c.HEAPF32.buffer,y,E).slice();return c._free(y),{name:h,array:C,itemSize:_}}function a(c,u){switch(u){case Float32Array:return c.DT_FLOAT32;case Int8Array:return c.DT_INT8;case Int16Array:return c.DT_INT16;case Int32Array:return c.DT_INT32;case Uint8Array:return c.DT_UINT8;case Uint16Array:return c.DT_UINT16;case Uint32Array:return c.DT_UINT32}}}const J1=3,eR=60,tR=1e3/eR,nR=()=>{const s=ye.useRef(null),e=ye.useRef(null),t=ye.useRef(null),i=ye.useRef(null),o=ye.useRef(null),a=ye.useRef(null),c=ye.useRef(null),u=ye.useRef(0),[f,h]=ye.useState(!1),[p,m]=ye.useState(!0),_=ye.useCallback(S=>{if(!(!e.current||!t.current||!i.current)){if(S-u.current<tR){c.current=requestAnimationFrame(_);return}u.current=S;try{const E=S*.001;if(a.current&&(a.current.rotation.x=E*.1,a.current.rotation.y=E*.05),o.current){const M=(o.current.rotation.y+.01)%(Math.PI*2);o.current.rotation.y=M,o.current.position.y=Math.sin(E*1.2)*.05,o.current.scale.x!==1&&o.current.scale.set(1,1,1)}i.current.render(e.current,t.current),c.current=requestAnimationFrame(_)}catch(E){console.error("Animation error:",E),i.current&&e.current&&t.current&&i.current.render(e.current,t.current),c.current=requestAnimationFrame(_)}}},[]);return ye.useEffect(()=>{let S=0,E=!1,M=!1;if(!s.current)return;const v=s.current,y=document.createElement("canvas");if(!(y.getContext("webgl")||y.getContext("experimental-webgl"))){console.warn("WebGL not available, showing fallback"),h(!0);return}try{let w=function(){if(M)return;const j=new _1,I=new Z1;I.setDecoderPath("/draco/"),j.setDRACOLoader(I),j.load("/assets/3d/proteindna.glb",G=>{if(E||M)return;E=!0,m(!1);const q=G.scene;q.scale.set(8,8,8),q.position.set(0,0,0),q.traverse(te=>{te.isMesh&&(te.castShadow=!1,te.receiveShadow=!1,te.material&&te.material.isMeshStandardMaterial&&(te.material.roughness=.7,te.material.metalness=.1,te.material.needsUpdate=!0),te.geometry&&(te.geometry.computeBoundingSphere(),te.geometry.computeBoundingBox()))}),o.current=q,L.add(q),!ue&&!M&&(ue=!0,u.current=performance.now(),_(performance.now()))},()=>{},G=>{console.error("Model loading error:",G),S<J1&&!M?(S++,setTimeout(w,1e3)):(h(!0),m(!1))})};const L=new PA;e.current=L;const z=v.clientWidth,O=v.clientHeight,F=new Ln(75,z/O,.1,1e3),ce=window.innerWidth<=768;F.position.z=ce?2.3:2,F.position.y=.1,F.position.x=-.1,t.current=F;const b=new ov({antialias:!0,alpha:!0,powerPreference:"high-performance",stencil:!1,depth:!0});b.setSize(z,O),b.setClearColor(0,0),b.shadowMap.enabled=!1,b.setPixelRatio(Math.min(window.devicePixelRatio,2)),i.current=b,v.appendChild(b.domElement),b.domElement.style.width="100%",b.domElement.style.height="100%",b.domElement.style.position="relative",b.domElement.style.left="0",b.domElement.style.top="0";const D=new o1(16777215,.8);L.add(D);const ae=new fv(16775399,1.5);ae.position.set(5,10,7),L.add(ae);let ue=!1;w();const _e=50,V=new oi,Q=new Float32Array(_e*3),oe=new Float32Array(_e*3);for(let j=0;j<_e;j++)Q[j*3]=(Math.random()-.5)*8,Q[j*3+1]=(Math.random()-.5)*8,Q[j*3+2]=(Math.random()-.5)*8,oe[j*3]=.6+Math.random()*.4,oe[j*3+1]=.2+Math.random()*.3,oe[j*3+2]=.8+Math.random()*.2;V.setAttribute("position",new nn(Q,3)),V.setAttribute("color",new nn(oe,3));const le=new Cf({size:.04,vertexColors:!0,transparent:!0,opacity:.5}),W=new cv(V,le);a.current=W,L.add(W);const Z=()=>{if(M||!F||!b||!v)return;const j=v.clientWidth,I=v.clientHeight;F.aspect=j/I,F.updateProjectionMatrix(),b.setSize(j,I)};return window.addEventListener("resize",Z),()=>{M=!0,c.current&&(cancelAnimationFrame(c.current),c.current=null),window.removeEventListener("resize",Z),b&&v.contains(b.domElement)&&(v.removeChild(b.domElement),b.dispose()),L&&L.clear(),e.current=null,t.current=null,i.current=null,o.current=null,a.current=null}}catch(w){console.error("3D setup error:",w),h(!0),m(!1)}},[_]),A.jsxs("div",{ref:s,className:"hero-3d",style:{width:"100%",height:"100%",position:"relative"},children:[p&&A.jsx("div",{style:{position:"absolute",left:"50%",top:"50%",transform:"translate(-50%, -50%)",color:"#666",fontSize:"14px",zIndex:1},children:"Loading 3D Model..."}),f&&A.jsx("img",{src:"/assets/images/fallback.png",alt:"3D Fallback",className:"hero-3d-fallback",style:{position:"absolute",left:"50%",top:"50%",transform:"translate(-50%, -50%)",width:"300px",height:"auto",zIndex:1}})]})},Ac=({page:s})=>{const e=()=>{switch(s){case"landing":return["/assets/images/landing1.png","/assets/images/landing2.png","/assets/images/landing3.png"];case"technology":return["/assets/images/technology1.png","/assets/images/technology2.png","/assets/images/technology3.png"];case"company":return["/assets/images/company2.png"];default:return[]}};return A.jsx("div",{className:`background-blobs background-blobs--${s}`,children:e().map((t,i)=>{let o={height:"auto"};return s==="landing"?i===0?(o.top="1650px",o.left="0%",o.width="clamp(200px, 40vw, 400px)"):i===1?(o.top="1250px",o.right="0%",o.width="clamp(200px, 40vw, 400px)"):i===2&&(o.top="400px",o.left="0%",o.width="clamp(200px, 40vw, 400px)"):s==="technology"?i===0?(o.top="1830px",o.left="0%",o.width="clamp(200px, 40vw, 500px)"):i===1?(o.top="0px",o.right="0%",o.width="clamp(200px, 40vw, 500px)"):i===2&&(o.top="800px",o.left="0%",o.width="clamp(200px, 40vw, 350px)"):s==="company"?i===0&&(o.top="0px",o.left="0%",o.width="clamp(200px, 40vw, 530px)"):s==="contact"&&(i===0?(o.top="500px",o.left="0%",o.width="clamp(150px, 35vw, 300px)"):i===1&&(o.top="1000px",o.right="0%",o.width="clamp(150px, 35vw, 300px)")),A.jsx("img",{src:t,alt:"",className:`blob blob-${i+1}`,style:o},i)})})},iR=()=>(ye.useEffect(()=>{document.title="Varosync - Home"},[]),A.jsxs(A.Fragment,{children:[A.jsx("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:-10,pointerEvents:"none",background:`
      ...
      `}),A.jsx("section",{className:"landing-content-section",children:A.jsxs("div",{className:"landing-content-grid",style:{display:"flex",flexDirection:"row",alignItems:"flex-start"},children:[A.jsx("div",{className:"landing-content-image",style:{flex:1}}),A.jsx("div",{style:{flex:1,display:"flex",justifyContent:"flex-start",width:"100%",paddingRight:"20px"},children:A.jsx("div",{className:"landing-content-text",style:{maxWidth:"600px",marginLeft:"-150px",width:"100%"},children:A.jsxs("p",{className:"landing-content-body",style:{fontSize:"1.5rem",fontWeight:"300",fontFamily:"var(--font-family)"},children:[A.jsx("br",{}),A.jsx("br",{}),"The ability to engineer matter at the molecular level demands a new class of instrument. One that operates beyond static blueprints, providing a computational environment where the complex motion of proteins becomes a deterministic design parameter. It is a system designed to augment scientific intuition, enabling our partners to build the molecular technologies of the future."]})})})]})}),A.jsx("section",{className:"mobile-blob-section-left",children:A.jsx("img",{src:"/assets/images/landing1.png",alt:"Mobile blob decoration left",className:"mobile-blob-image-left"})}),A.jsx("section",{className:"landing-content-section",children:A.jsxs("div",{className:"landing-partners-container",children:[A.jsx("h2",{className:"landing-content-subtitle",style:{fontSize:"3rem",fontWeight:"400",fontFamily:"var(--font-family)"},children:"Our Partners"}),A.jsxs("div",{className:"landing-partners-grid",children:[A.jsx("img",{src:"/assets/images/partnera.png",alt:"Partner company 1",className:"landing-content-img-plain",loading:"lazy"}),A.jsx("img",{src:"/assets/images/partnerb.png",alt:"Partner company 2",className:"landing-content-img-plain",loading:"lazy"})]})]})}),A.jsx("section",{className:"landing-content-section",children:A.jsxs("div",{className:"landing-recognized-container",children:[A.jsx("h2",{className:"landing-content-subtitle",style:{fontSize:"3rem",fontWeight:"400",fontFamily:"var(--font-family)"},children:"Recognized by"}),A.jsx("div",{style:{height:"12px"}}),A.jsxs("div",{className:"landing-recognized-grid",children:[A.jsx("img",{src:"/assets/images/inceptionlogo.svg",alt:"Inception logo",className:"landing-content-img-plain",loading:"lazy",style:{transform:"scale(1.3)",transformOrigin:"center"}}),A.jsx("img",{src:"/assets/images/nybio.png",alt:"NYBIO logo",className:"landing-content-img-plain",loading:"lazy"}),A.jsx("img",{src:"/assets/images/nsf-icorps.png",alt:"Nsf-icorps logo",className:"landing-content-img-plain",loading:"lazy",style:{transform:"scale(1.5)",transformOrigin:"center"}}),A.jsx("img",{src:"/assets/images/theventures.svg",alt:"The Ventures logo",className:"landing-content-img-plain",loading:"lazy",style:{transform:"scale(1.3)",transformOrigin:"center"}})]})]})}),A.jsx("style",{children:`
      ...
      `})]})),rR=()=>{const[s,e]=ye.useState(60);ye.useEffect(()=>{document.title="Varosync - Technology"},[]),ye.useEffect(()=>{const o=()=>{const a=document.getElementById("tech-video");if(!a)return;if(window.innerWidth<=768){e(90);return}const u=a.getBoundingClientRect(),f=window.innerHeight;if(u.bottom>0&&u.top<f){const m=60+30*Math.max(0,Math.min(1,(f-u.top)/f));e(m)}};return window.addEventListener("scroll",o),window.addEventListener("resize",o),o(),()=>{window.removeEventListener("scroll",o),window.removeEventListener("resize",o)}},[]);const t={fontSize:"1.5rem",fontWeight:"300",fontFamily:"var(--font-family)"},i={fontSize:"1.35rem",fontWeight:"300",fontFamily:"var(--font-family)"};return A.jsxs(A.Fragment,{children:[A.jsx("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:-10,pointerEvents:"none",backgroundColor:"#f0f6fd",transition:"background 1s"},"aria-hidden":"true"}),A.jsx(Ac,{page:"technology"}),A.jsx("section",{className:"hero",children:A.jsxs("div",{className:"hero-content",style:{textAlign:"left",marginTop:"50px",marginLeft:"20px",marginRight:"140px"},children:[A.jsx("div",{className:"hero-title-container",style:{border:"1px solid black",borderRadius:"8px",padding:"20px",position:"relative",display:"inline-block",maxWidth:"900px"},children:A.jsx("h1",{style:{fontSize:"4rem",fontWeight:"300",margin:0,color:"#000000",fontFamily:"var(--font-family)"},children:"Agentic orchestation of biological complexity"})}),A.jsx("div",{className:"hero-text-container",style:{paddingBottom:"0px"},children:A.jsx("p",{className:"page-subtitle",style:t,children:"We decode the dynamic behavior that determines protein function. Our multi-agent engine combines knowledge-grounded encoders with massively parallel molecular dynamics to map rare conformational states and reveal functional insights invisible to static structure analysis. This generates precision targets and binding strategies for biology's hardest problems."})})]})}),A.jsx("div",{className:"tech-inline-blob-3","aria-hidden":"true",style:{display:"none"},children:A.jsx("img",{src:"/assets/images/technology3.png",alt:""})}),A.jsx("section",{className:"tech-video-section",children:A.jsx("div",{className:"tech-video-container",children:A.jsxs("video",{id:"tech-video",autoPlay:!0,muted:!0,loop:!0,playsInline:!0,style:{width:`${s}%`,height:"auto",borderRadius:"20px",display:"block",margin:"0 auto",maxWidth:"100%"},children:[A.jsx("source",{src:"/assets/videos/outputech.mp4",type:"video/mp4"}),"Your browser does not support the video tag."]})})}),A.jsx("section",{className:"tech-content-section",children:A.jsxs("div",{className:"tech-content-block",children:[A.jsxs("div",{className:"tech-content-inner",children:[A.jsx("p",{style:t,children:"Proteins breathe and shift through constant motion. Critical conformational changes emerge and vanish within microseconds, such as transient states  and binding competent geometries. Traditional methods struggle to capture these dynamic events at the necessary resolution and scale."}),A.jsx("p",{style:t,children:"At the heart of our engine is a multi-agent workflow that explores high-dimensional conformational landscapes. Strategic retrievals leverage knowledge-grounded encoders to generate hypotheses about functional pathways from biological data and literature. These insights direct empirical agents to execute adaptive molecular dynamics simulations, efficiently sampling rare states where mechanistic insight emerges. Each cycle refines the system's predictive models, accelerating the path from hypothesis to validated biological understanding "})]}),A.jsx("div",{className:"tech-inline-blob-1","aria-hidden":"true",style:{display:"none"},children:A.jsx("img",{src:"/assets/images/technology1.png",alt:""})})]})}),A.jsx("section",{className:"tech-content-section-split",children:A.jsxs("div",{className:"tech-split-container",children:[A.jsx("div",{className:"tech-content-left",children:A.jsx("div",{className:"tech-content-left-boxed",children:A.jsx("div",{className:"tech-content-inner",children:A.jsx("p",{style:i,children:"The engine delivers high-confidence functional annotations and intervention strategies with atomic-level precision. By integrating learned biological priors with insights from scientific literature, we explore alternative conformational pathways and reveal design opportunities overlooked by structure-centric methods."})})})}),A.jsx("div",{className:"tech-image-right",children:A.jsx("div",{className:"tech-image-right-boxed",children:A.jsx("img",{src:"/assets/images/handchip.png",alt:"Technology Visualization"})})})]})})]})},sR=()=>(ye.useEffect(()=>{document.title="Varosync - Company"},[]),A.jsxs(A.Fragment,{children:[A.jsx("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:-10,pointerEvents:"none",background:"#effae2",transition:"background 1s"},"aria-hidden":"true"}),A.jsx(Ac,{page:"company"}),A.jsx("div",{className:"spacing nav-height"}),A.jsx("section",{className:"hero",style:{position:"relative",marginTop:"100px",paddingTop:"50px",paddingBottom:"0px",display:"flex",alignItems:"flex-start",justifyContent:"normal"},children:A.jsxs("div",{className:"hero-content",style:{marginLeft:"clamp(5px, 5vw, 400px)",maxWidth:"clamp(600px, 75vw, 1000px)",marginRight:"clamp(20px, 5vw, 50px)",marginTop:"0px",paddingBottom:"40px"},children:[A.jsx("div",{className:"hero-title-container",children:A.jsx("h1",{style:{fontSize:"4rem",fontWeight:"300",margin:0,color:"#000000",fontFamily:"var(--font-family)"},children:"Solving the attrition problem"})}),A.jsxs("div",{className:"hero-text-container",style:{paddingBottom:"0px"},children:[A.jsx("p",{className:"page-subtitle",style:{fontSize:"1.5rem",fontWeight:"300",fontFamily:"var(--font-family)"},children:"Varosync was founded to build the definitive computational engine for the next era of molecular design. Our mission is to overcome the limitations of static tools, enabling the design of precision molecules against the world's most challenging protein targets. Our core belief is that a true understanding of molecular systems is dynamic. The frontier lies not in static observation, but in computing the complex conformational motions of proteins. Within these rare, transitional states lie the most significant design opportunities. These states were previously invisible to researchers."}),A.jsx("p",{className:"page-subtitle",style:{fontSize:"1.5rem",fontWeight:"300",fontFamily:"var(--font-family)"},children:"Our purpose is to translate deep computational understanding into decisive insights. We are committed to refining this technology to empower the scientific community, accelerating discovery, and redefining what is possible in molecular engineering."})]})]})}),A.jsxs("section",{className:"content",style:{position:"relative",marginTop:"80px"},children:[A.jsxs("div",{className:"content-with-image",children:[A.jsx("div",{className:"company-info",children:A.jsxs("div",{className:"partnership",children:[A.jsx("h2",{style:{fontSize:"2.2rem",fontWeight:"300",fontFamily:"var(--font-family)"},children:"Partnerships that push boundaries "}),A.jsx("p",{style:{fontSize:"1.2rem",fontWeight:"300",fontFamily:"var(--font-family)"},children:"Our culture of collaboration reaches well beyond our own walls and forms the foundation of every partnership, whether with pharmaceutical firms, biotechs, CROs, or other forward-thinking innovators. Our partnerships bring us together in pursuit of a common aim to develop medicines for those who need them most. Transformative discoveries demand tenacity, bold thinking, and true collaboration. That's why we champion rigorous, high-potential science at every stage, applying our expertise to help turn ambitious ideas into tangible breakthroughs."}),A.jsx("img",{src:"/assets/images/company3.png",alt:"",className:"company1-blob company3-blob-inline"})]})}),A.jsx("div",{className:"content-image",children:A.jsx("img",{src:"/assets/images/pillcomp.png",alt:"Company Pill",style:{border:"none",boxShadow:"none",display:"block",maxWidth:"100%",width:"100%",height:"auto",objectFit:"contain"}})})]}),A.jsx("img",{src:"/assets/images/company1.png",alt:"",className:"company1-blob content-blob"})]})]})),oR=()=>{ye.useEffect(()=>{document.title="Varosync - News"},[]);const s='-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, sans-serif',e=[{id:1,date:"2024",title:"AI Powers a New Era of Drug Discovery and Development",author:"Nature",excerpt:"This article discusses how the integration of artificial intelligence (AI) and big data is revolutionizing the drug discovery process. By combining AI with expert knowledge, pharmaceutical companies are accelerating the development of more effective medicines, reducing the time and cost traditionally associated with bringing new drugs to market. This hybrid approach is poised to provide new treatment options for patients worldwide.",category:"Research",size:"large",url:"https://www.nature.com/articles/d42473-024-00250-9"},{id:2,date:"2023",title:"Molecular Free Energies, Rates, and Mechanisms from Data-Efficient Path Sampling Simulations",author:"Journal of Chemical Theory and Computation (ACS)",excerpt:"This paper introduces a data-efficient method for exploring reaction pathways and free energy surfaces using machine learning-enhanced path sampling. It highlights how physical priors and statistical inference can reduce simulation costs while improving mechanistic fidelity—an approach that aligns closely with our interest in model-driven simulations of pharmacokinetics and biomolecular interactions.",category:"Research",size:"medium",url:"https://pubs.acs.org/doi/10.1021/acs.jctc.3c00821"},{id:3,date:"2024",title:"Starfysh Integrates Spatial Transcriptomic and Histologic Data to Reveal Heterogeneous Tumour–Immune Hubs",author:"Nature Biotechnology",excerpt:"This study introduces Starfysh, a computational framework that combines spatial transcriptomic data with histological context to identify cellular neighbourhoods within the tumour microenvironment. The method enables high-resolution mapping of tumour–immune interactions, uncovering functional hubs that are invisible to conventional analysis. For Varosync, this illustrates the power of integrative modelling in resolving biological heterogeneity.",category:"Research",size:"medium",url:"https://www.nature.com/articles/s41587-024-02173-8"},{id:4,date:"2025",title:"Introducing Varosync",author:"",excerpt:"As we shape the future of pharma, we're proud to introduce Varosync.",category:"Tech",size:"medium",url:"https://www.varosync.com"}];return A.jsxs(A.Fragment,{children:[A.jsx("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:-10,pointerEvents:"none",background:`
