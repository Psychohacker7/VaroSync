...
`);this.workerSourceURL=URL.createObjectURL(new Blob([c]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){const o=new Worker(this.workerSourceURL);o._callbacks={},o._taskCosts={},o._taskLoad=0,o.postMessage({type:"init",decoderConfig:this.decoderConfig}),o.onmessage=function(a){const c=a.data;switch(c.type){case"decode":o._callbacks[c.id].resolve(c);break;case"error":o._callbacks[c.id].reject(c);break;default:console.error('THREE.DRACOLoader: Unexpected message, "'+c.type+'"')}},this.workerPool.push(o)}else this.workerPool.sort(function(o,a){return o._taskLoad>a._taskLoad?-1:1});const i=this.workerPool[this.workerPool.length-1];return i._taskCosts[e]=t,i._taskLoad+=t,i})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log("Task load: ",this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==""&&URL.revokeObjectURL(this.workerSourceURL),this}}function Q1(){let s,e;onmessage=function(c){const u=c.data;switch(u.type){case"init":s=u.decoderConfig,e=new Promise(function(p){s.onModuleLoaded=function(m){p({draco:m})},DracoDecoderModule(s)});break;case"decode":const f=u.buffer,h=u.taskConfig;e.then(p=>{const m=p.draco,_=new m.Decoder;try{const S=t(m,_,new Int8Array(f),h),E=S.attributes.map(M=>M.array.buffer);S.index&&E.push(S.index.array.buffer),self.postMessage({type:"decode",id:u.id,geometry:S},E)}catch(S){console.error(S),self.postMessage({type:"error",id:u.id,error:S.message})}finally{m.destroy(_)}});break}};function t(c,u,f,h){const p=h.attributeIDs,m=h.attributeTypes;let _,S;const E=u.GetEncodedGeometryType(f);if(E===c.TRIANGULAR_MESH)_=new c.Mesh,S=u.DecodeArrayToMesh(f,f.byteLength,_);else if(E===c.POINT_CLOUD)_=new c.PointCloud,S=u.DecodeArrayToPointCloud(f,f.byteLength,_);else throw new Error("THREE.DRACOLoader: Unexpected geometry type.");if(!S.ok()||_.ptr===0)throw new Error("THREE.DRACOLoader: Decoding failed: "+S.error_msg());const M={index:null,attributes:[]};for(const v in p){const y=self[m[v]];let b,w;if(h.useUniqueIDs)w=p[v],b=u.GetAttributeByUniqueId(_,w);else{if(w=u.GetAttributeId(_,c[p[v]]),w===-1)continue;b=u.GetAttribute(_,w)}const P=o(c,u,_,v,y,b);v==="color"&&(P.vertexColorSpace=h.vertexColorSpace),M.attributes.push(P)}return E===c.TRIANGULAR_MESH&&(M.index=i(c,u,_)),c.destroy(_),M}function i(c,u,f){const p=f.num_faces()*3,m=p*4,_=c._malloc(m);u.GetTrianglesUInt32Array(f,m,_);const S=new Uint32Array(c.HEAPF32.buffer,_,p).slice();return c._free(_),{array:S,itemSize:1}}function o(c,u,f,h,p,m){const _=m.num_components(),E=f.num_points()*_,M=E*p.BYTES_PER_ELEMENT,v=a(c,p),y=c._malloc(M);u.GetAttributeDataArrayForAllPoints(f,m,v,M,y);const b=new p(c.HEAPF32.buffer,y,E).slice();return c._free(y),{name:h,array:b,itemSize:_}}function a(c,u){switch(u){case Float32Array:return c.DT_FLOAT32;case Int8Array:return c.DT_INT8;case Int16Array:return c.DT_INT16;case Int32Array:return c.DT_INT32;case Uint8Array:return c.DT_UINT8;case Uint16Array:return c.DT_UINT16;case Uint32Array:return c.DT_UINT32}}}const J1=3,eR=()=>{const s=Ee.useRef(null),e=Ee.useRef(null),t=Ee.useRef(null),i=Ee.useRef(null),o=Ee.useRef(null),a=Ee.useRef(null),c=Ee.useRef(null),[u,f]=Ee.useState(!1);return Ee.useEffect(()=>{let h=0,p=!1;if(!s.current)return;const m=s.current,_=new NA;e.current=_;const S=m.clientWidth,E=m.clientHeight,M=new Ln(75,S/E,.1,1e3);M.position.z=2,M.position.y=.1,M.position.x=-.1,t.current=M;const v=new lv({antialias:!0,alpha:!0});v.setSize(S,E),v.setClearColor(0,0),v.shadowMap.enabled=!0,v.shadowMap.type=C_,i.current=v,m.appendChild(v.domElement),v.domElement.style.width="100%",v.domElement.style.height="100%",v.domElement.style.position="relative",v.domElement.style.left="0",v.domElement.style.top="0";const y=new o1(16777215,.99);_.add(y);const b=new hf(16775399,2.2);b.position.set(5,10,7),b.castShadow=!0,b.shadow.mapSize.width=1024,b.shadow.mapSize.height=1024,_.add(b);const w=new pv(16777215,1.5,100);w.position.set(-5,5,10),_.add(w);const P=new hf(16777215,.7);P.position.set(-10,10,-10),_.add(P);let z=!1,O={x:0,y:0},F={x:0,y:0};const ce=X=>{if(!m)return;const j=m.getBoundingClientRect(),D=(X.clientX-j.left)/j.width*2-1,V=-((X.clientY-j.top)/j.height)*2+1;F.x=V*.18,F.y=D*.18},L=()=>{F.x=0,F.y=0};m.addEventListener("mousemove",ce),m.addEventListener("mouseleave",L);function I(){const X=new _1,j=new Z1;j.setDecoderPath("/draco/"),X.setDRACOLoader(j),X.load("/assets/3d/proteindna.glb",D=>{if(p)return;p=!0;const V=D.scene;V.scale.set(8,8,8),V.position.set(0,0,0),V.traverse(Y=>{Y.isMesh&&(Y.castShadow=!0,Y.receiveShadow=!0,Y.material&&Y.material.isMeshStandardMaterial&&(Y.material.roughness=.7,Y.material.metalness=.1,Y.material.needsUpdate=!0))}),o.current=V,_.add(V),z||(z=!0,W())},void 0,()=>{h<J1?(h++,setTimeout(I,1e3)):f(!0)})}I();const ae=100,ue=new oi,me=new Float32Array(ae*3),G=new Float32Array(ae*3);for(let X=0;X<ae;X++)me[X*3]=(Math.random()-.5)*10,me[X*3+1]=(Math.random()-.5)*10,me[X*3+2]=(Math.random()-.5)*10,G[X*3]=.6+Math.random()*.4,G[X*3+1]=.2+Math.random()*.3,G[X*3+2]=.8+Math.random()*.2;ue.setAttribute("position",new nn(me,3)),ue.setAttribute("color",new nn(G,3));const ee=new Lf({size:.05,vertexColors:!0,transparent:!0,opacity:.6}),se=new dv(ue,ee);a.current=se,_.add(se);const le=()=>{if(!M||!v||!m)return;const X=m.clientWidth,j=m.clientHeight;M.aspect=X/j,M.updateProjectionMatrix(),v.setSize(X,j)};window.addEventListener("resize",le);const W=()=>{c.current=requestAnimationFrame(W);const X=Date.now()*.001;a.current&&(a.current.rotation.x=X*.1,a.current.rotation.y=X*.05),O.x+=(F.x-O.x)*.08,O.y+=(F.y-O.y)*.08,o.current&&(o.current.rotation.y=X*.3+O.y,o.current.rotation.x=O.x,o.current.position.y=Math.sin(X*1.2)*.08,o.current.rotation.z=0,o.current.scale.set(1,1,1)),v.render(_,M)};return()=>{c.current&&cancelAnimationFrame(c.current),m.removeEventListener("mousemove",ce),m.removeEventListener("mouseleave",L),window.removeEventListener("resize",le),v&&m.contains(v.domElement)&&(m.removeChild(v.domElement),v.dispose()),_&&_.clear()}},[]),A.jsx("div",{ref:s,className:"hero-3d",style:{width:"100%",height:"100%",position:"relative"},children:u&&A.jsx("img",{src:"/assets/images/fallback.png",alt:"3D Fallback",className:"hero-3d-fallback",style:{position:"absolute",left:"50%",top:"50%",transform:"translate(-50%, -50%)",width:"300px",height:"auto",zIndex:1}})})},wa=({page:s})=>{const e=()=>{switch(s){case"landing":return["/assets/images/landing1.png","/assets/images/landing2.png","/assets/images/landing3.png"];case"technology":return["/assets/images/technology1.png","/assets/images/technology2.png","/assets/images/technology3.png"];case"company":return["/assets/images/company1.png","/assets/images/company2.png"];case"news":return["/assets/images/news1.png","/assets/images/news2.png","/assets/images/news3.png"];default:return[]}};return A.jsxs("div",{className:"background-blobs",children:[e().map((t,i)=>{let o={width:"clamp(150px, 35vw, 300px)",height:"auto"};return s==="landing"?i===0?(o.top="310%",o.left="0%",o.width="clamp(200px, 40vw, 400px)"):i===1?(o.top="230%",o.right="0%",o.width="clamp(200px, 40vw, 400px)"):i===2&&(o.top="120%",o.left="0%",o.width="clamp(200px, 40vw, 400px)"):s==="technology"?i===0?(o.top="99%",o.left="0%",o.width="clamp(200px, 40vw, 500px)"):i===1?(o.top="0%",o.right="0%",o.width="clamp(200px, 40vw, 500px)"):i===2&&(o.top="187%",o.right="0%",o.width="clamp(200px, 40vw, 350px)"):s==="company"?i===0?(o.top="70%",o.right="-2%"):i===1&&(o.top="0%",o.left="0%",o.width="clamp(200px, 40vw, 530px)"):s==="news"?i===0?(o.top="100%",o.right="0%",o.width="clamp(250px, 45vw, 450px)"):i===1?(o.top="20%",o.left="0%",o.width="clamp(150px, 35vw, 300px)"):i===2&&(o.top="158%",o.left="-2%",o.width="clamp(400px, 70vw, 700px)"):s==="contact"?i===0?(o.top="30%",o.left="0%"):i===1&&(o.top="70%",o.right="0%"):(o.top=`${20+i*30}%`,o[i%2===0?"left":"right"]="0%"),A.jsx("img",{src:t,alt:"",className:`blob blob-${i+1} ${s}-blob-${i+1}`,style:o},i)}),A.jsx("style",{children:`
      ...
      `})]})},tR=()=>(Ee.useEffect(()=>{document.title="Varosync - Home"},[]),A.jsxs(A.Fragment,{children:[A.jsx("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:-10,pointerEvents:"none",background:`
